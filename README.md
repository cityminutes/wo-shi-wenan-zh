...
```bash
git clone https://github.com/cityminutes/wo-shi-wenan-zh.git ~/.codex/skills/wo-shi-wenan-zh
```

在 Codex 中輸入：

```text
使用 $wo-shi-wenan-zh 訪談我，並為這個品牌建立核心敘事系統。
```
...
英文版：[I Am Copywriter](https://github.com/cityminutes/wo-shi-wenan-en)
